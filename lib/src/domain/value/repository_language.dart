...
part 'repository_language.g.dart';
...
// see:https://github.com/susatthi/github-search/blob/develop/lib/domain/repositories/repo/entities/values/repo_language.dart

extension RepositoryLanguageHelper on RepositoryLanguage {
  // 表示用
  String get display => value;

  Color get languageColor {
    // カラーリストから該当のカラーコードを取得
    final hexColor = _languageHexes.entries.firstWhere(
      (element) => element.key == value,
    );
    // 16進数に変換
    return HexColor(hexColor.value);
  }
